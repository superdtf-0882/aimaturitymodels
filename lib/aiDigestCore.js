...
* Two of the instructions below restate governed rules rather than asserting independently: M9's no-averaging rule is \`P-11\`; G2's preserve-asymmetries posture is Rule 8, stated here for a reader with no one to ask.
...
G2. **Preserve issued asymmetries — do not editorially reconcile.** This digest contains real, deliberate asymmetries: dimensions that carry per-transition verification clauses beside dimensions that do not, one model with an Indicative evidence column and two without, function models with a Boundary Note and one without. These are the issued state, not drafting oversights, and smoothing them into an apparent consistency destroys information. This is not a new rule invented for external readers — it is the practice's own Rule 8 discipline (*if the record and the statement conflict, ask — never reconcile silently*), stated here for a reader who has no one to ask. Where you cannot ask, report the asymmetry and proceed against what the record actually says.
